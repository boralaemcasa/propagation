...
begin
  ...
  // multiplicar i por cada algarismo de a
     ...
     begin
       application.mainform.caption := 'mult algarismo ' + inteirotostr(i);
   ...
   for i := 1 to length(b) do
     if b[i] <> #0 then
      ...
      // zeros aa direita
         ...
         //WriteLine('subtotal' + inttostr(i) + '.253', subtotal);

      // o resultado é a soma dos subtotais
         soma253(Resultado, subtotal);

          application.mainform.Caption := 'multiplica ' + inteirotostr(i)
           + ' / ' + inteiroToStr(length(b));
          application.processMessages;
       end;
