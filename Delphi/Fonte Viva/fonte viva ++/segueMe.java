novoCapitulo("Segue-me 1 - SINAL DE AMOR");
novoVersiculo("João 8, 11");
processarSM("\"E saíram os fariseus e começaram a disputar com ele, " +
...
"Emmanuel " +
novoCapitulo("Segue-me 2 - RESISTÊNCIA ESPIRITUAL");
novoVersiculo("Atos 16, 25");
processarSM("\"Era perto da meia-noite; Paulo e Silas oravam e " +
...
novoCapitulo("Segue-me 3 - CAMINHOS CRUZADOS");
novoVersiculo("2_Pedro 3, 3");
processarSM("“Sabendo primeiro isto:que nos últimos dias virão escarnecedores, " +
...
novoCapitulo("Segue-me 4 - CONTRA O PERIGO");
novoVersiculo("Lucas 12, 8");
processarSM("\"E digo-vos que todo aquele que me confessor, diante " +
...
novoCapitulo("Segue-me 5 - FILHOS DE DEUS");
novoVersiculo("Lucas 21, 19");
processarSM("\"Na vossa paciência, possui as nossas almas\". - Jesus " +
"(Lucas, 21:19)\n" +
...
"Deus.");
novoCapitulo("Segue-me 6 - OBEDIÊNCIA JUSTA");
novoVersiculo("Filipenses 2, 6");
processarSM("\"Que, sendo em forma de Deus não teve por " +
...
"ironia de todos.");
novoCapitulo("Segue-me 7 - NÃO PEQUES DEMAIS");
novoVersiculo("João 8, 11");
processarSM("\"Vai e não peques mais\". - Jesus.\n" +
"(João, 8:11).\n" +
...
"invigilância.");
novoCapitulo("Segue-me 8 - A CURA PRÓPRIA");
novoVersiculo("Mateus 9, 35");
processarSM("\"Pregando o Evangelho do Reino e curando todas " +
"as enfermidades\"\n" +
"MATEUS, 9:35.\n" +
...
novoCapitulo("Segue-me 9 - O BEM QUE NÃO FOI FEITO");
novoVersiculo("Tiago 2, 14");
processarSM("\"Meus irmãos, que aproveita se alguém disser que tem fé e não " +
...
novoCapitulo("Segue-me 10 - ONDE O REPOUSO");
novoVersiculo("Mateus 8, 3");
processarSM("\"E Jesus, estendendo as mãos, tocou-o, dizendo: Quero, sê " +
"limpo...\"\n" +
"(Mateus, 8:3)\n" +
"Mãos estendidas!...\n" +
...
"bênção.");
novoCapitulo("Segue-me 11 - SEM RUÍDOS");
novoVersiculo("João 16, 13");
processarSM("\"Mas quando vier aquele Espírito de Verdade, ele " +
...
"colocou a redenção e deu as criaturas o amor como guia.\n" +
...
novoCapitulo("Segue-me 12 - AS FORÇAS DO AMANHÃ");
novoVersiculo("1_Coríntios 5, 6");
processarSM("\"Não sabeis que um pouco de fermento leveda a massa toda?\"\n" +
...
novoCapitulo("Segue-me 13 - LUZ EM NOSSAS MÃOS");
novoVersiculo("Lucas 17, 20");
processarSM("\"Interrogado pelos fariseus sobre quando viria o reino de Deus, " +
...
novoCapitulo("Segue-me 14 - ESTA NOITE");
novoVersiculo("Lucas 12, 20");
processarSM("\"Mas Deus lhe disse: Louco, esta noite te pedirão a tua alma; " +
...
novoCapitulo("Segue-me 15 - FAZER LUZ");
novoVersiculo("Romanos 14, 1");
processarSM("\"Acolhei o que é débil na fé, não, porém, para discutir opiniões\".\n" +
"- Paulo. (Romanos, 14:1).\n" +
...
novoCapitulo("Segue-me 16 - ALGUÉM DEVE PLANTAR");
novoVersiculo("1_Coríntios 3, 6");
processarSM("\"Eu plantei, Apolo regou, mas o crescimento veio de Deus\".\n" +
...
"deve plantar.");
novoCapitulo("Segue-me 17 - O PROVEITO DE TODOS");
novoVersiculo("1_Coríntios 12, 7");
processarSM("“A manifestação do Espírito é concedida a cada um, " +
...
novoCapitulo("Segue-me 18 - FUNDO DE SERVIÇO");
novoVersiculo("Lucas 12, 15");
processarSM("\"... Tende cuidado e guardai-vos de toda e qualquer " +
...
novoCapitulo("Segue-me 19 - O PONTO CERTO");
novoVersiculo("1_Pedro 4, 19");
processarSM("\"Por isso também os que sofrem, segundo a vontade de Deus, " +
...
"nos Céus, é aquele da prática do bem.\n" +
"Não nos iludamos.\n" +
...
"com Deus.");
novoCapitulo("Segue-me 20 - BENÇÃO DO SOL");
novoVersiculo("Hebreus 12, 15");
processarSM("\"... Nem haja alguma raiz de amargura que, brotando, nos perturbe e, " +
...
"Sol.");
novoCapitulo("Segue-me 21 - O AMOR PURO");
novoVersiculo("Hebreus 10, 24");
processarSM("\"Consideremo-nos também uns aos outros para nos " +
...
"bem e realizaremos o melhor ao nosso alcance, no terreno da ação.\n" +
...
"para a vida maior.");
novoCapitulo("Segue-me 22 - RECURSOS E CAMINHOS");
novoVersiculo("1_João 5, 14");
processarSM("\"E esta é a confiança que temos para com ele, " +
...
"das necessidades de hoje e amanhã.\n" +
...
novoCapitulo("Segue-me 23 - CONFIAREMOS");
novoVersiculo("1_João 5, 15");
processarSM("\"E se sabemos que ele nos ouve, quanto ao que lhe pedimos, " +
...
"essenciais - o pedido e a solução.\n" +
...
novoCapitulo("Segue-me 24 - PROBLEMAS DO AMOR");
novoVersiculo("Filipenses 1, 10");
processarSM("“Para que aproveis as coisas que são excelentes, " +
...
novoCapitulo("Segue-me 25 - VIVER EM PAZ");
novoVersiculo("2_Coríntios 13, 11");
processarSM("“...Vivei em paz...\"\n" +
...
"poucos.");
novoCapitulo("Segue-me 26 - A SABEDORIA DO ALTO");
novoVersiculo("Tiago 3, 17");
processarSM("\"Mas a sabedoria que vem do Alto é pura, pacífica, moderada, tratável, " +
...
"nome do Senhor, não necessita de longos e complicados discursos.\n" +
...
"para os que se aproximem da fonte em que se exterioriza.\n" +
...
"energia que constrói e a gentileza que estimula.\n" +
...
"dia.");
novoCapitulo("Segue-me 27 - OS SÁBIOS REAIS");
novoVersiculo("Tiago 3, 13");
processarSM("\"Quem dentre vós é sábio e entendido mostre por seu bom trato " +
...
novoCapitulo("Segue-me 28 - SOMENTE ASSIM");
novoVersiculo("João 15, 8");
processarSM("\"Nisto é glorificado meu Pai, que deis muito fruto; e assim " +
...
"espalhando as bênçãos de sua bondade infinita entre bons e maus, justos e injustos.\n" +
...
"integremos, vitoriosos, em seu divino amor e possamos glorificá-Lo.\n" +
"Nunca chegaremos, contudo, a semelhante condição, simplesmente através dos mil " +
"modos de coloração brilhante dos nossos sentimentos e raciocínios.\n" +
...
"necessárias, e representam as folhas vivas e promissoras.\n" +
...
"universal, produzindo para o bem eterno.\n" +
...
novoCapitulo("Segue-me 29 - PÁGINA DO MOÇO ESPÍRITA CRISTÃO");
novoVersiculo("1_Timóteo 4, 12");
processarSM("\"Ninguém despreze a tua mocidade; mas sê o exemplo dos fiéis na palavra, " +
"no trato, na caridade, no espírito, na fé e na pureza\".\n" +
...
novoCapitulo("Segue-me 30 - MENSAGEM DO NATAL");
novoVersiculo("Lucas 2, 14");
processarSM("\"Gloria a Deus nas Alturas, paz na Terra e boa vontade para com os homens\".\n" +
"(Lucas, 2:14)\n" +
...
"dores, ao encontro das almas. Não amaldiçoa.\n" +
"Não condena.\n" +
"Não fere.\n" +
...
novoCapitulo("Segue-me 31 - NATAL");
novoVersiculo("Lucas 2, 14");
processarSM("\"Gloria a Deus nas Alturas, paz na Terra e boa vontade para com os Homens\".\n" +
"(Lucas, 2:14)\n" +
...
"disposto a sublime renuncia até a cruz.\n" +
"*** " +
...
"recorda que o Mestre veio ate nós para que nos amemos uns aos outros.\n" +
"* * * " +
...
novoCapitulo("Segue-me 32 - QUE FAREI?");
novoVersiculo("Atos 22, 10");
processarSM("\"Que farei?\" - Paulo. ATOS,22:10.\n" +
...
"Presença Divina, é padrão para todos os aprendizes e seguidores da Boa Nova.\n" +
...
"amor, através do próprio sacrifício.\n" +
...
novoCapitulo("Segue-me 33 - NA LUTA VULGAR");
novoVersiculo("Gálatas 6, 7");
processarSM("\"Pois aquilo que o homem semear, isso também ceifará.\n" +
"Paulo (Gálatas, 6:7)\n" +
...
"indiferença pelas dores que lhe são próprias.\n" +
...
"vizinhos encontraremos a antipatia e a desconfiança.\n" +
...
"fraterno dos grupos anônimos que nos cercam.\n" +
...
novoCapitulo("Segue-me 34 - INTERROGAÇÃO DO MESTRE");
novoVersiculo("Lucas 9, 25");
processarSM("”Que aproveita ao homem granjear o mundo todo, " +
"perdendo-se ou prejudicando a sim mesmo?”.\n" +
"JESUS – Lucas, 9:25.\n" +
...
novoCapitulo("Segue-me 35 - A GRAÇA DO SENHOR");
novoVersiculo("2_Corintios 12, 9");
processarSM("\" A minha graça te basta.\"\n" +
"( Corintios, 12:9)\n" +
...
novoCapitulo("Segue-me 36 - OPEREMOS");
novoVersiculo("Filipenses 2, 12");
processarSM("“...Operai a vossa salvação...”-Paulo. (Filipenses, 2:12)\n" +
...
"no buril, para que a obra-prima de estatuária se expresse, vitoriosa...\n" +
...
"existência e de nossa alma, a fim de que os valores do céu nos sublimem a vida.\n" +
...
novoCapitulo("Segue-me 37 - RENOVEMO-NOS");
novoVersiculo("2_Coríntios 5, 17");
processarSM("\"Se alguém está em Cristo, nova criatura é\"\n" +
...
"soletrado jamais qualquer ensinamento na linguagem da ação.\n" +
...
"com Ele, assimilando-lhe a palavra e seguindo-lhe o exemplo.\n" +
...
novoCapitulo("Segue-me 38 - OBEDEÇAMOS");
novoVersiculo("Filemom 1, 21");
processarSM("Escrevi-te confiando na tua obediência, " +
...
novoCapitulo("Segue-me 39 - DE ALMAS NO AMOR");
novoVersiculo("1_João 3, 18");
processarSM("\"Que não amemos de palavras nem de língua, mas de obras e de verdade\"\n" +
"- João (I João, 3:18)\n" +
...
"trabalho e coração.");
novoCapitulo("Segue-me 40 - DE MÃOS NO BEM");
novoVersiculo("1_Pedro 2, 17");
processarSM("\"Honrai a todos. Amai a Fraternidade\". - (I Pedro, 2:17)\n" +
"Sabemos que o Cristo espera por nos, acima de tudo, ao lado de " +
"nossos irmãos na Terra.\n" +
"Onde surgem dificuldades e provas, ei-lo aí aguardando-nos a " +
"intervenção para que o concurso fraterno se faca sentir de pronto.\n" +
"Muitas vezes porem, diante do companheiro teimoso e rude, " +
"exclamamos, desalentados: - \"já fiz tudo\", \"agora não posso mais\".\n" +
...
"se afligem, encorajando-as com o nosso testemunho de paciência e boa vontade.\n" +
...
novoCapitulo("Segue-me 41 - GRANDE SERVIDOR");
novoVersiculo("Lucas 22, 27");
processarSM("“Eu estou entre vós como quem serve”.\n" +
"— Jesus (Lucas, 22:27)\n" +
...
novoCapitulo("Segue-me 42 - NO JUBILO DE SERVIR");
novoVersiculo("Lucas 17, 10");
processarSM("\"Depois de haverdes feito quanto vos foi ordenado, dizei: somos servos " +
...
novoCapitulo("Segue-me 43 - PÁGINA DO NATAL");
novoVersiculo("Lucas 2, 32");
processarSM("“Luz para alumiar as nações.” – Lucas, 2-32 " +
...
"ciúme e da discórdia que atira corações aos precipícios do crime e do sofrimento.\n" +
...
novoCapitulo("Segue-me 44 - BILHETE FRATERNO");
novoVersiculo("Mateus 9, 41");
processarSM("“Qualquer que vos der a beber um copo d’água em meu nome,em " +
...
novoCapitulo("Segue-me 45 - NO QUADRO REAL");
novoVersiculo("João 17, 14");
processarSM("“Dei-lhes a tua palavra, e o mundo os aborreceu, " +
...
novoCapitulo("Segue-me 46 - A ÁGUA FLUÍDA");
novoVersiculo("Mateus 10, 42");
processarSM("“E qualquer que tiver dado só que seja um copo de água fria por ser meu discípulo, " +
...
novoCapitulo("Segue-me 47 - O PASSE");
novoVersiculo("Mateus 8, 17");
processarSM("“Ele tomou sobre si as nossas enfermidades e levou as nossas doenças.”\n" +
"(Mateus, 8:17)\n" +
...
"doenças.");
novoCapitulo("Segue-me 48 - FRATERNIDADE");
novoVersiculo("1_João 4, 7");
processarSM("\"Amemo-nos uns aos outros... \" (I João, 4:7)\n" +
"Nem um só monumento do passado revela o espírito de fraternidade nas " +
"grandes civilizações que precederam o Cristianismo.\n" +
...
"imundície e os fracos e os velhos eram condenados a morte sem comiseração.\n" +
...
"para governar as almas na Terra.\n" +
...
novoCapitulo("Segue-me 49 - SERVIÇO");
novoVersiculo("2_Tessalonicenses 3, 8");
processarSM("\"... Trabalhando para não sermos pesados a nenhum de vós\".\n" +
"- Paulo. (II Tessalonicenses, 3:8).\n" +
...
novoCapitulo("Segue-me 50 - NA DIFUSÃO DO ESPIRITISMO");
novoVersiculo("João 14, 16");
processarSM("\"E eu rogarei ao Pai e Ele vos dará outro " +
...
novoCapitulo("Segue-me 51 - AO CLARÃO DA VERDADE");
novoVersiculo("João 16, 13");
processarSM("“Mas quando vier aquele Espírito de " +
"verdade, ele vos guiará em toda verdade...”\n" +
"– Jesus (João 16:13)\n" +
...
"seguinte interrogação: “De que maneira pode o Espiritismo contribuir para o progresso””\n" +
...
"educação.");
novoCapitulo("Segue-me 52 - NA SEARA DO AUXÍLIO");
novoVersiculo("Colossenses 3, 13");
processarSM("“Suportando-vos uns aos outros e perdoando-os uns aos outros, " +
...
"pesquisa e definição do plano terrestre.\n" +
...
"auxiliarmos, construirmos e reconstruirmos para o bem de todos.\n" +
"Pensemos nisso.\n" +
...
novoCapitulo("Segue-me 53 - A PORTA DA PALAVRA");
novoVersiculo("Colossenses 4, 3");
processarSM("\"Orando também, juntamente por nós para que " +
"Deus nos abra a porta da palavra ...\"\n" +
"- Paulo (Colossenses, 4:3)\n" +
...
"conheçam os sentimentos e problemas, os ideais e realizações.\n" +
...
novoCapitulo("Segue-me 54 - SINAIS DO CÉU");
novoVersiculo("João 6, 26");
processarSM("\"Jesus lhes respondeu e disse: -Na verdade, na verdade vos digo que me buscais, " +
...
"exibir fatos: resume-se em possuir a necessária visão espiritual para compreendêlos.\n" +
...
novoCapitulo("Segue-me 55 - O FARDO");
novoVersiculo("Gálatas 6, 5)");
processarSM("“Cada qual levará a sua própria carga”.\n" +
"Paulo. (Gálatas, 6:5).\n" +
...
novoCapitulo("Segue-me 56 - EM EQUIPE ESPÍRITA");
novoVersiculo("Mateus 18, 19");
processarSM("\"Em verdade vos digo que se dois dentre vós, sobre a Terra, concordarem a respeito " +
...
"mais necessitados que nós mesmos, ou socorrer uma criança.\n" +
...
novoCapitulo("Segue-me 57 - GRUPO EM CRISE");
novoVersiculo("João 15, 7");
processarSM("“Se permanecerdes em mim e a minhas palavras permanecerem em vós, " +
...
"devidamente estabilizadas, a crise explode.\n" +
...
"serenidade maior. Diante deles nada de irritação, nem desânimo.\n" +
...
"condições de serviços nos trilhos justos, seguir para frente.\n" +
...
novoCapitulo("Segue-me 58 - RECLAMAR MENOS");
novoVersiculo("Mateus 7, 12");
processarSM("“Tudo quanto, pois, quereis que os homens vos façam, " +
...
"reclamar, - na maioria das ocasiões, - por simples bagatelas.\n" +
...
"comprometem a vida comunitária desentendimentos, rixas, perturbações e acusações.\n" +
...
novoCapitulo("Segue-me 59 - NOS CAMINHOS DA FÉ");
novoVersiculo("Mateus 10, 32");
processarSM("\"Portanto, todo aquele que me confessar diante dos homens, " +
...
novoCapitulo("Segue-me 60 - NO GRUPO ESPÍRITA");
novoVersiculo("Mateus 18, 20");
processarSM("“Porque , onde estiverem dois ou três reunidos em meu nome , " +
...
novoCapitulo("Segue-me 61 - NA SEARA MEDIÚNICA");
novoVersiculo("Mateus 5, 13");
processarSM("\"Vós sois o sal da Terra; ora, se o sal vier a ser insípido, como lhe restaurar o sabor?\"\n" +
"- Jesus - (Mateus, 5:13)\n" +
...
"a si próprio na esfera dos serviços consagrados ao bem:\n" +
...
"evidente menosprezo dos compromissos assumidos?\n" +
...
"habitualmente reclamando conserto?\n" +
...
"próprias obrigações quando a enfermidade ou a provação lhe batem à porta?\n" +
...
novoCapitulo("Segue-me 62 - QUESTÕES DO COTIDIANO");
novoVersiculo("Mateus 6, 13)");
processarSM("\"... E não nos deixeis cair em tentação, mas livrai-nos do mal...\"\n" +
"- Jesus. (Mateus, 6:13).\n" +
...
novoCapitulo("Segue-me 63 - NA ESCOLA DIÁRIA");
novoVersiculo("Mateus 6, 34");
processarSM("\"Portanto, não vos inquieteis com o dia de " +
...
"conserva o pensamento atormentado e convulso.\n" +
...
"qualquer lucro nos impacientarmos, conturbando ou destruindo a própria resistência.\n" +
"Muito aluno digno perde a prova em que se acha incurso o ensino não pela feição do " +
"problema proposto, e sim pela própria excitabilidade na hora justa da promoção.\n" +
...
"trabalho com oportunidade de melhoria.\n" +
...
novoCapitulo("Segue-me 64 - OPOSIÇÕES");
novoVersiculo("Mateus 5, 44");
processarSM("\"Eu, porém, vos digo: amai os vossos inimigos e orai pelos que vos perseguem\".\n" +
"- Jesus (Mateus, 5:44)\n" +
"Imperioso modifiques a própria conceituação, em torno do adversário, a fim de " +
"que se te apague da mente, em definitivo, o fogo da aversão.\n" +
...
"companheiros em posições mais elevadas que a nossa.\n" +
...
"a advertência de Jesus quando nos recomendou a oração pelos que nos perseguem.\n" +
...
novoCapitulo("Segue-me 65 - OBSESSÕES");
novoVersiculo("Mateus 6, 13)");
processarSM("“...e não nos deixei cair em tentação mas livra-nos do mal”\n" +
"– Jesus (Mateus, 6:13).\n" +
...
"surgem as grandes brechas na organização da vida ou na moradia da alma:\n" +
...
novoCapitulo("Segue-me 66 - ELOGIOS E CRÍTICAS");
novoVersiculo("Tiago 1, 17");
processarSM("\"Toda boa dádiva e todo dom perfeito é lá do Alto, descendo do Pai das luzes, em " +
...
"teria descido à condição de um cemitério no Espaço.\n" +
...
novoCapitulo("Segue-me 67 - CARIDADE DA PAZ");
novoVersiculo("Mateus 5, 9");
processarSM("“Bem-aventurados os pacificadores” - Jesus (Mateus, 5:9)\n" +
"Um tipo de beneficência ao alcance de todos e que não se deve esquecer — ocultar os " +
"próprios aborrecimentos, a fim de auxiliar.\n" +
"*** " +
...
"expande, à feição de tóxico mental, atacando a todos os que se deixem contagiar.\n" +
...
"remanescentes de laboriosa faxina.\n" +
...
"modo a espalhar bênçãos e criar energias angariando-te simpatia e cooperação.\n" +
"*** " +
...
novoCapitulo("Segue-me 68 - O NECESSÁRIO");
novoVersiculo("Lucas 10, 42");
processarSM("\"Mas uma só coisa é necessária.\" - Jesus. (LUCAS, 10:42.)\n" +
"Terás muitos negócios próximos ou remotos, mas não poderás subtrair-lhes o caráter de " +
"lição, porque a morte te descerrará realidades com as quais nem sonhas de leve...\n" +
...
"proveito.");
novoCapitulo("Segue-me 69 - MANDATO PESSOAL");
novoVersiculo("1_Pedro 4, 10");
processarSM("\"Servi uns aos outros, cada um conforme o dom " +
...
"aqueles que povoam o cérebro alheio e mostras vocação de que outros não dispõem.\n" +
...
novoCapitulo("Segue-me 70 - TEUS ENCARGOS");
novoVersiculo("Mateus 5, 48");
processarSM("\"...Sede vós perfeito como perfeito é o vosso Pai Celestial\".\n" +
"- Jesus (Mateus, 5:48).\n" +
...
"compete efetuar, na pauta de nosso próprio merecimento.\n" +
...
"de realização a que, por enquanto, te podes consagrar.\n" +
...
"fazer, na elevação da própria vida.\n" +
...
"seres inconfundíveis da Criação.\n" +
...
"começar a ser bom.");
novoCapitulo("Segue-me 71 - DIREITO");
novoVersiculo("Mateus 10, 42");
processarSM("\"E qualquer que tiver dado só que seja um copo dágua fria a um " +
...
"circunstâncias da vida identificamos os mais diferentes direitos.\n" +
...
"da espontaneidade ou podar os interesses alheios.\n" +
...
"tua correção não se transforme em ofensa ou desencorajamento nos outros.\n" +
"Guardas o direito de analisar; todavia se ainda não entesouraste bastante " +
"experiência para compreender é possível que a observação exagerada te leve à secura.\n" +
...
"martelo endereçado à destruição.\n" +
...
"suscetíveis de ferir esse ou aquele companheiro em posição mais desvantajosa que a tua.\n" +
...
novoCapitulo("Segue-me 72 - FORÇA");
novoVersiculo("João 15, 12");
processarSM("\"O meu mandamento é este: que vos amei " +
...
"fraternal na intimidade do ser.\n" +
...
"dos distritos no campo do sentimento.\n" +
...
novoCapitulo("Segue-me 73 - TEU CONCURSO");
novoVersiculo("1_Pedro 2, 16");
processarSM("\"Como livres e não tendo a liberdade por cobertura de malícia, " +
...
novoCapitulo("Segue-me 74 - DO LADO DE DEUS");
novoVersiculo("João 3, 16");
processarSM("\"Porque Deus amou o mundo de tal maneira que deu o seu Filho unigênito, " +
...
"Perfeito Amor, garantindo-nos segurança e equilíbrio.\n" +
...
"felicidade de todas as criaturas.\n" +
...
"Deus.");
novoCapitulo("Segue-me 75 - ESCOLHAS");
novoVersiculo("João 15, 10");
processarSM("\"Se guardardes os meus mandamentos, permanecereis " +
"no meu amor...\" - Jesus (João, 15:10)\n" +
...
novoCapitulo("Segue-me 76 - NA EXPERIÊNCIA DIÁRIA");
novoVersiculo("João 15, 17");
processarSM("“Isto vos mando, que vos ameis uns aos outros”.\n" +
"– Jesus. (João, 15:17).\n" +
...
novoCapitulo("Segue-me 77 - AÇÃO E PRECE");
novoVersiculo("Mateus 7, 7");
processarSM("Pedi e dar-se-vos-á; buscai e achareis; batei e abrir-se-vos-á.\n" +
"- Jesus. (Mateus, 7:7).\n" +
"Prece é luz.\n" +
...
"favor dos companheiros que lhes solicitam apoio e cooperação na Terra.\n" +
...
"prodígios da colheita deve plantar.\n" +
"O artista possui a pedra e os instrumentos com que lhe possa alterar a estrutura, " +
"mas se quer a obra-prima há que burilá-la com atenção.\n" +
"No versículo sétimo do capítulo sete dos apontamentos do apóstolo Mateus, no " +
"Evangelho, diz-nos Jesus: \"Pedi e dar-se-vos-á; buscai e achareis; batei e abrir-se-vos-á\".\n" +
...
"vos descerrem os horizontes e as realizações que demandais.\n" +
...
novoCapitulo("Segue-me 78 - VONTADE E RENOVAÇÃO");
novoVersiculo("1_João 2, 21");
processarSM("\"Não vos escrevi porque não sabeis a verdade, mas " +
"porque a sabeis...\" - (I João, 2:21)\n" +
...
"dos compromissos menos felizes que carreia para a frente na jornada espiritual.\n" +
...
"transformando-se em azedume e incompreensão para os melhores amigos...\n" +
"Queremos todos a felicidade e a paz; todavia é preciso reconhecer que a paz e a " +
"felicidade se nos levantam do íntimo.\n" +
...
novoCapitulo("Segue-me 79 - NAS DIRETRIZES DO EVANGELHO");
novoVersiculo("Mateus 7, 20");
processarSM("\"Assim, pois, pelos seus frutos os conhecereis\". - Jesus " +
"(Mateus, 7:20)\n" +
"O Senhor não nos induziu a conhecer o valor da árvore pelas " +
"exterioridades ou dificuldades de sua vinculação com a terra.\n" +
...
"melhores botânicos não consegue determinar.\n" +
...
"quebraram os ramos a fim de se lhe apropriarem dos recursos.\n" +
...
"conhecereis\".");
novoCapitulo("Segue-me 80 - O SERVO DO SENHOR");
novoVersiculo("João 17, 16");
processarSM("\"Eles não são do mundo como também eu não sou\". - Jesus " +
"(João, 17:16)\n" +
...
novoCapitulo("Segue-me 81 - A PORTA DIVINA");
novoVersiculo("João 10, 9");
processarSM("\"Eu sou a porta; se alguém entrar por mim, salvar-se-á\"\n" +
"- Jesus. (João, 10:9).\n" +
...
"cada pessoa que segue à frente de nós abre portas ao nosso espírito.\n" +
...
"despenhadeiros onde o perigo é incessante.\n" +
...
"palavra falada ou escrita, da ação ou do exemplo.\n" +
"Examina onde entras com o sagrado depósito da confiança. Muita vez perderás " +
"longo tempo para retomar o caminho que te é próprio.\n" +
...
novoCapitulo("Segue-me 82 - AUXILIAR E SERVIR");
novoVersiculo("Lucas 10, 27");
processarSM("\"... E amarás o teu próximo como a ti mesmo\". - Jesus " +
"(Lucas, 10:27)\n" +
"Irmãos!\n" +
...
novoCapitulo("Segue-me 83 - A LÍNGUA");
novoVersiculo("Tiago 3, 6");
processarSM("“A língua também é um fogo.” - (Tiago, 3:6.)\n" +
...
"de criar, tanto quanto o leme de proporções reduzidas foi instalado para conduzir.\n" +
...
"propósitos mesquinhos, a mingua de humildade e amor.\n" +
...
"acusar e ferir desapiedadamente.\n" +
