...
begin
  memoOut.text := CommandProcess(MemoIn.text, ExtractFilePath(Application.ExeName) + LOG_FILE);
end;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              t := WithParenthesisProcess(true, t, LOGFILE);
...
begin
  ...
  if t <> '' then
  begin
    s := WithParenthesisProcess(false, t, LOGFILE);
    if s = '' then
    begin
      result := '';
      exit;
  ...
  repeat
    ...
    if t <> '' then
    begin
      s := WithParenthesisProcess(true, t, LOGFILE);
      if s = '' then
      begin
        result := '';
        exit;
...
begin
  ...
  begin
    result := result + #13#10#13#10'ERROR: Variable ' + variable + ' is composite.';
    exit;
  end;
...
begin
  ...
  begin
    MemoIn.Clear;
    MemoOut.Clear;
    memoin.lines.LoadFromFile('..\teste2.txt');
  end;
end;
