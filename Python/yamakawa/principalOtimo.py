...
import fsYamakawa
K = fsYamakawa.metodoYamakawaOtimo(nVariaveis, xt, ydt, constPCA)
print("colunas", K)
xt = xt[:,K]
xv = xv[:,K]
nVariaveis = np.shape(xt)[1]
...
alpha = 0
xa = 0
out_fis,trainError,incertTrein = fsYamakawa.anfis_yamakawaOtimo(xt, ydt, constNFuncPertinencia)
