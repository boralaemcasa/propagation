...
RUNHIBRID(2,gap,passo,separar);
RUNHIBRID(4,gap,passo,separar);
RUNHIBRID(6,gap,passo,separar);
RUNHIBRID(10,gap,passo,separar);
RUNHIBRID(14,gap,passo,separar);
RUNHIBRID(18,gap,passo,separar);
RUNHIBRID(20,gap,passo,separar);
RUNHIBRID(22,gap,passo,separar);
RUNHIBRID(24,gap,passo,separar);
RUNHIBRID(26,gap,passo,separar);
