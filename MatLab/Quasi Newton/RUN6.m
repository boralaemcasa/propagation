...
disp(['média = ' + numero2str(media_t)])
disp(['mediana = ' + numero2str(mediana_t)])
disp(['desvio padrão = ' + numero2str(desvio_t)])
disp(['erro padrão = ' + numero2str(erro_t)])
disp(['variância = ' + numero2str(variancia_t)])
disp(['mínimo = ' + numero2str(minimo_t)])
disp(['máximo = ' + numero2str(maximo_t)])
disp('----------------------------------------------')
disp('Nº DE ITERAÇÕES:')
disp(['média = ' + numero2str(media_ni)])
disp(['mediana = ' + numero2str(mediana_ni)])
disp(['desvio padrão = ' + numero2str(desvio_ni)])
disp(['erro padrão = ' + numero2str(erro_ni)])
disp(['variância = ' + numero2str(variancia_ni)])
disp(['mínimo = ' + numero2str(minimo_ni)])
disp(['máximo = ' + numero2str(maximo_ni)])
disp('----------------------------------------------')
disp('Nº DE AVALIAÇÕES DE f(x):')
disp(['média = ' + numero2str(media_na)])
disp(['mediana = ' + numero2str(mediana_na)])
disp(['desvio padrão = ' + numero2str(desvio_na)])
disp(['erro padrão = ' + numero2str(erro_na)])
disp(['variância = ' + numero2str(variancia_na)])
disp(['mínimo = ' + numero2str(minimo_na)])
disp(['máximo = ' + numero2str(maximo_na)])
disp('----------------------------------------------')
% disp('ERRO PERCENTUAL DE X:')
% disp(['média = ' + numero2str(media_x)])
% disp(['mediana = ' + numero2str(mediana_x)])
% disp(['desvio padrão = ' + numero2str(desvio_x)])
% disp(['erro padrão = ' + numero2str(erro_x)])
% disp(['variância = ' + numero2str(variancia_x)])
% disp(['mínimo = ' + numero2str(minimo_x)])
% disp(['máximo = ' + numero2str(maximo_x)])
% disp('----------------------------------------------')
% disp('ERRO PERCENTUAL DE f(x):')
% disp(['média = ' + numero2str(media_fobj)])
% disp(['mediana = ' + numero2str(mediana_fobj)])
% disp(['desvio padrão = ' + numero2str(desvio_fobj)])
% disp(['erro padrão = ' + numero2str(erro_fobj)])
% disp(['variância = ' + numero2str(variancia_fobj)])
% disp(['mínimo = ' + numero2str(minimo_fobj)])
% disp(['máximo = ' + numero2str(maximo_fobj)])
% disp('----------------------------------------------')
end