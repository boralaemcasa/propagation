...
if s == 0
	subplot(2,2,1); 
    set(gca,'FontSize',18) ccf([e e],lag,0,1); grid; title('(a)')
	subplot(2,2,2); 
    set(gca,'FontSize',18) ccf([e e2],lag,1,1); grid;  title('(b)')
	subplot(2,2,3); 
    set(gca,'FontSize',18)ccf([e2p e2p],lag,0,1); grid;  title('(c)')
else
	subplot(2,2,1); ccf([e e],lag,0,1,'e(t) X e(t)'); grid;  
	subplot(2,2,2); ccf([e e2],lag,1,1,'e(t) X [e(t)-mean(e(t))]^2');
	grid;
	subplot(2,2,3); ccf([e2p e2p],lag,0,1,'[e(t)^2-mean(e(t)^2)] X [e(t)^2-mean(e(t)^2)]'); grid;
end;