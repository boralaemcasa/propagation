...
if comparar == 1:
   ...
   with open("V:\\sem backup\\redes neurais 2021 prova 23 ago\\lista final 02 setembro\\dados\\parameters.csv", newline='') as f:
   ...
   with open("V:\\sem backup\\redes neurais 2021 prova 23 ago\\lista final 02 setembro\\dados\\trainReduzido.csv", newline='') as f:
      ...
      for row in reader:
         ...
         #   break
   print("vou salvar")
   with open('V:\\sem backup\\redes neurais 2021 prova 23 ago\\lista final 02 setembro\\dados\\diferenca.csv', 'w', newline='') as f:
   ...
   print("vou salvar")
   with open('V:\\sem backup\\redes neurais 2021 prova 23 ago\\lista final 02 setembro\\dados\\parameters.csv', 'w', newline='') as f:
      writer = csv.writer(f, delimiter=',')
      writer.writerows(P)
